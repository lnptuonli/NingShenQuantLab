package com.ningshenquantlab.alphaforge_demo1.customer.entity;
/**
 * 用户实体类
 * 对应数据库表：user_acct
 **/
import com.ningshenquantlab.alphaforge_demo1.customer.validation.ContactCheck;
import com.ningshenquantlab.alphaforge_demo1.customer.validation.CreateGroup;
import com.ningshenquantlab.alphaforge_demo1.customer.validation.CustKey;
