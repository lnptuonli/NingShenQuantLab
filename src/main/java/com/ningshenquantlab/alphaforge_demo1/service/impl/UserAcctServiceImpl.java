...
import com.ningshenquantlab.alphaforge_demo1.mapper.UserAcctMapper;
import com.ningshenquantlab.alphaforge_demo1.service.UserAcctService;
...
public class UserAcctServiceImpl implements UserAcctService {
    ...
    public UserAcct update(UserAcct userAcct) {
        // 检查用户是否存在
        UserAcct existingUser = findByCustId(userAcct.getCustId());
